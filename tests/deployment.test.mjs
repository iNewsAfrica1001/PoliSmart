...
test("public homepage presents accurate V1 marketing while login remains separate", () => {
  ...
  assert.match(homepage, /Political Intelligence/);
  assert.match(homepage, /Workspace Search/);
  assert.match(homepage, /Media records from authorized integrations/i);
  ...
  assert.match(homepage, /Billing & Payments/);
  assert.match(homepage, /PoliSmart does not currently process payments/);
