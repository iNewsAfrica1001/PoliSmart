...
export function FundraisingPage({ user }: { user: SessionUser }) {
  ...
  return (
    <div className="fundraising-page">
      ...
      <aside className="fundraising-notice" role="note">
        Campaign organizations remain responsible for applicable campaign-finance, reporting,
        retention, and legal requirements. Use only the information needed for campaign
        administration. Do not enter payment credentials, government identification numbers,
        health information, religion, ethnicity, or other sensitive personal information. Do not
        enter card numbers, bank account details, passwords, or other payment credentials.
      </aside>
